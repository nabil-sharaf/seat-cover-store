            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 m-b30">
                        <div class="video-box">
                            <img src="{{asset('front')}}/images/nn.jpg" alt="">
                            <div class="video-play">
                                <a href="https://www.youtube.com/watch?v=_FRZVScwggM" class="popup-youtube gradient-shadow bg-gradient video"><i class="fas fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
