...
@section('content')
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title float-left">إضافة كوبون جديد</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form class="form-horizontal" action="{{ route('admin.promo-codes.store') }}" method="POST" dir="rtl">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="inputCode" class="col-sm-2 control-label">كود الكوبون</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('code') is-invalid @enderror" id="inputCode" placeholder="أدخل كود الكوبون" name='code' value="{{ old('code') }}">
