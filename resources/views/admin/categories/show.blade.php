...
@section('page-title')
تفاصيل النوع: {{ $category->name }}
@endsection
@section('content')
<div class="card">
    <div class="card-header">
        <h3 class="card-title">تفاصيل النوع</h3>
    </div>
    <div class="card-body">
        <!-- Breadcrumbs -->
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.categories.index') }}">الأنواع</a></li>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">معلومات التلبيسة</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h5 class="mb-0">الأنواع الفرعية</h5>
                    </div>
                    <div class="card-body">
                        ...
                        @else
                            <p>لا يوجد أنواع فرعية لهذا القسم.</p>
                        @endif
                    </div>
                </div>
            </div>
