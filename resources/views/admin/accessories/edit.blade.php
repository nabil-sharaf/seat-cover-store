                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="discount_type" id="discount_type"
                            ...
                            <option value="" {{ old('discount_type', $accessory->discount?->discount_type) == '' ? 'selected' : '' }}>لا يوجد</option>
                            <option value="fixed" {{ old('discount_type', $accessory->discount?->discount_type) == 'fixed' ? 'selected' : '' }}>ثابت</option>
                            <option value="percentage" {{ old('discount_type', $accessory->discount?->discount_type) == 'percentage' ? 'selected' : '' }}>نسبة
                                مئوية
                            </option>
                        </select>
                        @error('discount_type')
                ...
                <div class="form-group row mt-4 discount-fields" style="display: none;">
                    ...
                    <div class="col-sm-10">
                        <input type="number" step="0.01"
                               ...
                               placeholder="أدخل قيمة الخصم" name='discount_value'  value="{{ old('discount_value', $accessory?->discount?->discount_value) }}""
                               min="0">
                ...
                <div class="form-group row discount-fields" style="display: none;">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control @error('end_date') is-invalid @enderror" id="end_date"
                               placeholder="أدخل تاريخ نهاية الخصم" name='end_date' value="{{ old('end_date', $accessory?->discount?->end_date?->format('Y-m-d')) }}">
                        @error('end_date')
                        <div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                </div>
