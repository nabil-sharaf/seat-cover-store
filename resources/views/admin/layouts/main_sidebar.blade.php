    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('admin.sliders.index')}}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/settings/sliders*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{route('admin.branches.index')}}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/settings/branches*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>الفروع</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('admin.testimonials.index')}}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/settings/testimonials*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p> شهادات العملاء </p>
                            </a>
                        </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('admin.moderators.index')}}"
                                   class="nav-link {{ Request::is(app()->getLocale() .'/admin/moderators*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>المشرفين</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('admin.customers.index')}}"
                                   class="nav-link {{ Request::is(app()->getLocale() .'/admin/customers*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>العملاء</p>
                                </a>
                            </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.categories.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/categories') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل الأقسام</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.categories.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/categories/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>إضافة قسم</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview {{ Request::is(app()->getLocale() .'/admin/cover-colors*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link ">
                        <i class="nav-icon fas fa-chart-pie"></i>
                        <p class='font-weight-bold'>
                            ألوان التلبيسات
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.cover-colors.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/cover-colors') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل الألوان</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.cover-colors.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/cover-colors/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>إضافة لون</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.car-brands.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/car-brands') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل البراندات </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.car-brands.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/car-brands/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>إضافة براند</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.car-models.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/car-models') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل الموديلات </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.car-models.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/car-models/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>إضافة موديل</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview {{ Request::is(app()->getLocale() .'/admin/seat-counts*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.seat-counts.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/seat-counts') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل المقاعد </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.seat-counts.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/seat-counts/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>إضافة مقعد </p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview {{ Request::is(app()->getLocale() .'/admin/seat-prices*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.seat-prices.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/seat-prices') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل الأسعار </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.seat-prices.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/seat-prices/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item has-treeview {{ Request::is(app()->getLocale() .'/admin/bag-options*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.bag-options.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/bag-options') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل اسعار الشنط </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.bag-options.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/bag-options/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>إضافة سعر لشنطة </p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.accessories.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/accessories') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل الاكسسوارات</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.accessories.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/accessories/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>إضافة اكسسوار </p>
                            </a>
                        </li>
