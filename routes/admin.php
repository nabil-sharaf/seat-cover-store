...
//  ----- -------------------------Car Brands-----------------------
            Route::resource('car-brands', Adm\CarBrandController::class);
            Route::resource('car-models', Adm\CarModelController::class);
            Route::resource('seat-counts', SeatCountController::class);
            Route::resource('seat-prices', SeatPriceController::class);
            Route::resource('bag-options', BagOptionController::class);
