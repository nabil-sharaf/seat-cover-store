...
//    return Route::get('seat-cover-store/public/public/vendor/livewire/livewire.js', $handle);
//});
//Livewire::setUpdateRoute(function ($handle) {
//    return Route::post(LaravelLocalization::localizeURL('seat-cover-store/public/livewire/update'), $handle);
//});
...
Route::get('/test', function(){
    return view('front.livewire-test');
});
